    ...
    <div className="min-h-screen flex items-center justify-center bg-base-950 px-4">
      <div className="w-full max-w-sm card-surface rounded-2xl shadow-card p-7">
        <div className="flex items-center gap-2.5 mb-6">
          ...
          <div>
            <p className="text-[13px] font-bold tracking-tight text-gray-50 leading-none">
              DRIVN
            </p>
            <p className="text-[10px] text-gray-500 tracking-wide leading-none mt-1">
              MY CAR DASHBOARD
            </p>
          </div>
        </div>
        ...
        <form onSubmit={submit}>
          <p className="text-sm text-gray-400 mb-4">
            {isSignUp
              ? 'Create an account to sync your car data across every device.'
              : 'Sign in to access your car dashboard.'}
          </p>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-accent hover:bg-accent-light text-white text-sm font-medium rounded-xl px-4 py-2.5 shadow-glow transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
            <Lock size={15} />
            {loading
